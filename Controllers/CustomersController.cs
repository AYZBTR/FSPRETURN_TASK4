...
namespace FSPRETURN_TASK4.Controllers
{
    public class CustomersController : Controller
    {
        ...
        public CustomersController(FSPReturn4Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Customers != null ? 
                          ...
                          Problem("Entity set 'FSPReturn4Context.Customers'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'FSPReturn4Context.Customers'  is null.");
            }
            var customer = await _context.Customers.FindAsync(id);
            if (customer != null)
            {
