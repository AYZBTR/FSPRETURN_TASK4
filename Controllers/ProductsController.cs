...
namespace FSPRETURN_TASK4.Controllers
{
    public class ProductsController : Controller
    {
        ...
        public ProductsController(FSPReturn4Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Products != null ? 
                          ...
                          Problem("Entity set 'FSPReturn4Context.Products'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'FSPReturn4Context.Products'  is null.");
            }
            var product = await _context.Products.FindAsync(id);
            if (product != null)
            {
